...
$checks = [
    ...
    'HR payroll enforces canonical payment day' => str_contains((string)file_get_contents($root . '/core/Services/PayrollService.php'), 'PayrollCalendar::paymentDay($month)'),
