...
$receivedAt = date('Y-m-d H:i:s', time() - 3600);
$first = $service->receive('salary_advance', 1, 400, 'cash', $receivedAt, 99, '', 'first cash', 'key-1');
...
$same = $service->receive('salary_advance', 1, 400, 'cash', $receivedAt, 99, '', 'first cash', 'key-1');
...
$salaryFinal = $service->receive('salary_advance', 1, 600, 'cash', $receivedAt, 99, '', '', 'key-1-final');
...
$loan = $service->receive('employee_loan', 2, 900, 'transfer', $receivedAt, 99, 'BANK-1', '', 'key-2');
...
try {
    $service->receive('employee_loan', 2, 301, 'cash', $receivedAt, 99, '', '', 'key-3');
...
$final = $service->receive('employee_loan', 2, 300, 'cash', $receivedAt, 99, '', '', 'key-4');
