...
<div class="native-card tp-native-card tp-native-data-card tp-outside-filter-card p-4 sm:p-6 mb-6 min-w-0 overflow-hidden rounded-[var(--tp-ios-card-radius)]">
...
<div class="native-card tp-native-card tp-native-data-card tp-outside-list-card overflow-visible min-w-0 rounded-[var(--tp-ios-card-radius)]">
    ...
    <div class="space-y-4">
        ...
        ?>
        <article class="tp-outside-request-card rounded-[var(--tp-ios-card-radius)] p-4 sm:p-5">
