...
$availableScopes = [
    ...
    'dayoff.read'          => 'อ่านคำขอเปลี่ยนวันหยุด',
    'dayoff.write'         => 'สร้างคำขอเปลี่ยนวันหยุด',
    'dayoff.approve'       => 'อนุมัติ/ปฏิเสธเปลี่ยนวันหยุด',
    'overtime.read'        => 'อ่านคำขอ OT',
    'overtime.write'       => 'สร้างคำขอ OT',
    'overtime.approve'     => 'อนุมัติ/ปฏิเสธ OT',
    'outside.read'         => 'อ่านคำขอลงเวลานอกสถานที่',
    'outside.approve'      => 'อนุมัติ/ปฏิเสธลงเวลานอกสถานที่',
    'adjustments.read'     => 'อ่านคำขอปรับปรุงเวลา',
    'adjustments.approve'  => 'อนุมัติ/ปฏิเสธปรับปรุงเวลา',
    'payroll.read'         => 'อ่านข้อมูลเงินเดือน (approved/paid)',
    'hr.read'              => 'อ่าน metadata (แผนก/ตำแหน่ง/วันหยุด/ประเภทลา/กะ/ประกาศ)',
