...
**Mobile list shells:** **`md:hidden`** stacks **`p-5`** — **`attendance_history.php`**, **`hr/documents.php`**, **`hr/employees.php`**, **`hr/attendance.php`**, **`hr/employee_attendance.php`** (เดิม **`p-3`**).
