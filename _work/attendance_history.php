...
<main class="content-area p-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-2">
            <a href="attendance_adjustments.php" class="px-4 py-2.5 rounded-lg bg-violet-600 hover:bg-violet-700 text-white transition-colors">
                <i class="fas fa-pen-to-square mr-2"></i>ขอแก้ไขเวลา
            </a>
