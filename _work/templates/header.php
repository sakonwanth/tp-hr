...
<aside class="sidebar fixed left-0 top-0 w-[280px] h-screen overflow-y-auto hidden lg:block z-50">
    <div class="p-6">
        ...
        <nav class="space-y-1">
            ...
            <a href="/attendance_adjustments.php" class="nav-item <?php echo $current_page === 'attendance-adjustments' ? 'active' : ''; ?>">
                <i class="fas fa-pen-to-square"></i>
                <span>คำขอแก้ไขเวลา</span>
            </a>
        ...
        <div class="mt-6 pt-6 border-t border-slate-700/50">
            ...
            <nav class="space-y-1">
                ...
                <?php if (isCEOOrAbove()): ?>
                <a href="/hr/work_locations.php" class="nav-item <?php echo $current_page === 'hr-locations' ? 'active' : ''; ?>">
                    <i class="fas fa-map-marker-alt"></i>
                    <span>สถานที่ลงเวลา</span>
                </a>
                <?php endif; ?>
        ...
        <div class="p-6">
            ...
            <nav class="space-y-1">
                ...
                <div class="mt-4 pt-4 border-t border-slate-700/50">
                    ...
                    <a href="/hr/attendance.php" class="nav-item">
                        <i class="fas fa-user-clock"></i>
                        <span>จัดการลงเวลา</span>
                    </a>
                    <a href="/hr/attendance_adjustments.php" class="nav-item">
                        <i class="fas fa-clipboard-check"></i>
                        <span>อนุมัติแก้เวลา</span>
                    </a>
