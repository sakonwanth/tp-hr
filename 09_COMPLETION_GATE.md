...
**Refactor discipline:** No intentional changes to auth, API contracts, form field names, or modal/JS hook IDs in Waves 2–3.
...
1. Execute **`07_PAGE_REGRESSION_AFTER.md`** on Wave 2 routes and high-traffic **`hr/*`** pages (at least 375px and one desktop width).
...
| “All 04/06 tasks for Waves 1–3 done” | Yes, if `04` / `06` say so |
| “Zero UI issues on all devices” | **No** until device QA is done or explicitly waived |

---

*Aligned with `06_IMPLEMENTATION_PROGRESS.md`: 2026-04-28 — Waves **1–3** refactor rows marked **REFACTORED** / **COMPLETE**.*
